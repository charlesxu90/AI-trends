...
Conferences included: CVPR, ICCV, ICML, ICLR, NIPS.
...
| **Emerging topics** | 'token', 'federated learning', 'text-guided', 'low-rank', 'privacy' |
| **Fading topics**   | 'optical flow', 'self-supervision', 'chemical ai', 'distribution shifts', 'foundation models' |
...
| **Emerging topics** | 'diffusion models', 'low-rank', 'rl', 'optimal transport', 'chemical ai' |
| **Fading topics**   | 'monocular depth estimation', 'text-video', 'category discovery', 'layout', 'RAG' |

## 2022 ICML
| **Type**            | Topics |
|---------------------|--------|
| **Top 5 topics**    | 'graph', 'zero_few-shot', 'reinforcement learning', 'representation', 'embodied ai' |
| **Emerging topics** | 'chemical ai', 'self-learning', 'differential equation solving', 'multi-agent', 'llm' |
| **Fading topics**   | 'diffusion models', 'decision trees', 'camera', 'object detection', 'optimal transport' |
...
| **Type**            | Topics |
|---------------------|--------|
| **Top 5 topics**    | 'zero_few-shot', 'graph', 'reinforcement learning', 'optimization', 'flow' |
...
- Emerging topics: topics with increasing ratio among the top 5 (current count ≥ 10).
