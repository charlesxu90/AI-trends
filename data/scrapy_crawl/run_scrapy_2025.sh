...
# ICML
# scrapy crawl scrapy_openreview2 -o 2025/icml2025-oral.json  -a year=2025 -a source=ICML -a type=oral -a venue='ICML%202025%20oral' -a details='replyCount%2Cpresentation%2Cwritable' -a domain='ICML.cc%2F2025%2FConference' --nolog
# scrapy crawl scrapy_openreview2 -o 2025/icml2025-spotlight.json  -a year=2025 -a source=ICML -a type=spotlight -a venue='ICML%202025%20spotlightposter' -a domain='replyCount%2Cpresentation%2Cwritable' --nolog
scrapy crawl scrapy_openreview2 -o 2025/icml2025-poster1.json  -a year=2025 -a source=ICML -a type=poster -a venue='ICML%202025%20poster' -a details='replyCount%2Cpresentation%2Cwritable'  -a domain='ICML.cc%2F2025%2FConference'  --nolog -a limit=1000 
scrapy crawl scrapy_openreview2 -o 2025/icml2025-poster2.json  -a year=2025 -a source=ICML -a type=poster -a venue='ICML%202025%20poster' -a details='replyCount%2Cpresentation%2Cwritable'  -a domain='ICML.cc%2F2025%2FConference' --nolog -a offset=1000 -a limit=1000 
scrapy crawl scrapy_openreview2 -o 2025/icml2025-poster3.json  -a year=2025 -a source=ICML -a type=poster -a venue='ICML%202025%20poster' -a details='replyCount%2Cpresentation%2Cwritable'  -a domain='ICML.cc%2F2025%2FConference'  --nolog -a offset=2000 -a limit=1000 
